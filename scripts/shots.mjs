...
const pages = [
  ...
  ["stories", "/stories", 1440], ["blog", "/blog", 1440], ["post", "/blog/yos-exam-guide", 1440], ["consultation", "/consultation", 1440], ["compare", "/universities/compare?u=koc-university,sabanci-university,bogazici-university", 1440], ["faq", "/faq", 1440], ["contact", "/contact", 1440], ["admin-login", "/admin/login", 1440],
];
